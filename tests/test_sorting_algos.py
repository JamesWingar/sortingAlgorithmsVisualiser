...
class TestRecursiveSort(unittest.TestCase):
    ...
    def test_rand_mergeSort(self):
        lst = self.cloning(self.rand_numbers)
        self.assertTrue(self.is_sorted(recursive_sort.mergeSort(lst)))
    ...
    def test_rand_bubbleSort(self):
        lst = self.cloning(self.rand_numbers)
        self.assertTrue(self.is_sorted(recursive_sort.bubbleSort(lst, len(lst))))
    ...
    def test_rand_quickSort(self):
        lst = self.cloning(self.rand_numbers)
        self.assertTrue(self.is_sorted(recursive_sort.quickSort(lst, 0, len(lst) - 1)))
    ...
    def test_rand_heapSort(self):
        lst = self.cloning(self.rand_numbers)
        self.assertTrue(self.is_sorted(recursive_sort.heapSort(lst)))
...
class TestIterativeSort(unittest.TestCase):
    ...
    def test_rand_mergeSort(self):
        lst = self.cloning(self.rand_numbers)
        self.assertTrue(self.is_sorted(iterative_sort.mergeSort(lst)))
    ...
    def test_rand_bubbleSort(self):
        lst = self.cloning(self.rand_numbers)
        self.assertTrue(self.is_sorted(iterative_sort.bubbleSort(lst)))
    ...
    def test_rand_quickSort(self):
        lst = self.cloning(self.rand_numbers)
        self.assertTrue(self.is_sorted(iterative_sort.quickSort(lst)))
    ...
    def test_rand_heapSort(self):
        lst = self.cloning(self.rand_numbers)
        self.assertTrue(self.is_sorted(iterative_sort.heapSort(lst)))
